...
//        StreamingProfile.VideoProfile vProfile = new StreamingProfile.VideoProfile(30, 1000 * 1024, 48);
        StreamingProfile.VideoProfile vProfile = new StreamingProfile.VideoProfile(12, 800 * 900, 48);
//        StreamingProfile.VideoProfile vProfile = new StreamingProfile.VideoProfile(12, 250 * 256, 24);
...
//        mProfile.setVideoQuality(StreamingProfile.VIDEO_QUALITY_HIGH3)
        mProfile.setVideoQuality(StreamingProfile.VIDEO_QUALITY_MEDIUM3)
